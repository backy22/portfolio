...
'typography': {title: 'Typography', property: 'Typography<br>Adobe Illustrator',text: "I put three projects using typography.The first one is to express the meaning of a word and its opposite using typographic contrasts. I chose \"unstable\" and \"stable\". The second one is to arrange song lyrics using the typographic contrast with the principle of alignment and hierarchy. I chose \"Just The Way You Are\" of Bruno Mars. I balanced the size of fonts and chose the color to highlight. <br>The final one is the typographic specimen poster. I chose OPTIMA to promote in the poster.  I did some research about the history, designer, features and companies who use OPTIMA and show the results arranged with hierarchy. The type anatomy is my favorite part.",  images: ['typography-1.jpg', 'typography-2.jpg']},
...
'matrix': {title: 'Matrix', property: 'Adobe After Effects',text: "I used the character panel to create characters that rain down, ultimately spelling your name in Adobe After Effects.", images: ['XHbsLUddccE']},
  ...
  'albumcover': {title: 'Album Cover', property: 'Adobe Photoshop',text: "Two album covers for two different music genres using the same background image, title and band name. The genre of the first one is country pop music. Second one is healing music.", images: ['albumcover-1.jpg','albumcover-2.jpg']}
