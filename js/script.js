...
'weathermap': {title: 'Weather Map', property: 'jQuery<br>API', text: "This website shows the weather in any place you click on the map using the Open Weather Map API  and the Google Geocoding API. <p class=\"link\"><a href=\"https://ayatsubakino.com/creativecoding/weather\" target=\"blank\"> \>\> View the website</a><p>", images: ['SnNd_RBdF9I']},
'sushi': {title: 'Sushi Conveyor Belt', property: 'JavaScript<br>HTML<br>CSS',text: "This website is completely \"useless\" but will make you laugh. You can pick sushi from the conveyor belt and when you click the \"Check Please!\" button, the number of plates you picked appears. Then when you finish the payment,  you can continue to pick sushi again.<p class=\"link\"><a href=\"https://ayatsubakino.com/creativecoding/sushi/\" target=\"blank\"> \>\> View the website</a><p>", images: ['5gxkMYFUvrM']},
'mindmap': {title: 'Mindmap', property: 'JavaScript<br>Canvas',text: "I made an animated and interactive graphic using HTML5 Canvas and JavaScript. As the video shows, you can create your original mindmap and preview it with animation on the page.<p class=\"link\"><a href=\"https://ayatsubakino.com/creativecoding/canvas/mindmap/\" target=\"blank\"> \>\> View the website</a><p>", images: ['gDN7L0b2RZE']},
