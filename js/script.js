...
// project data
var projectData = {
'give&take': {title: 'Chat Application', property: 'Sketch<br>Mockup<br>React<br>Redux<br>Firebase',text: "This is the personal project of Sketch mockup and React web application. We are not motivated by only money. In this website, we can trade anything other than money by chatting about what we can 'give' and what we want to 'take.' I hope this way of thinking will have impact on our life style. <p class=\"link\"><a href=\"\" target=\"blank\"> \>\> View the website</a>&nbsp;&nbsp;<a href=\"https://github.com/backy22/givetake\" target=\"blank\"> \>\> Sourse code</a><p>", images: ['give&take-1.jpg', 'h7D4t1jYDgs']},
'sokka': {title: 'App Promotion Website', property: 'Adobe Photoshop<br>Mockup<br>HTML<br>CSS<br>JavaScript<br>Responsive',text: "This website is to promote the app named 'sokka.' I made two versions of high fidelity mockup in two days. After designing, I developed the responsive website using HTML, CSS and JavaScript for a several days based on the mockup the client finally chose and their feedbacks. I made effort on understanding what the client wanted to achieve in a short term. As a result, the client is satisfied with my work and released. <p class=\"link\"><a href=\"http://sokka.tokyo/en/index.html\" target=\"blank\"> \>\> View the website</a>&nbsp;&nbsp;<a href=\"https://github.com/backy22/sproject\" target=\"blank\"> \>\> Sourse code</a><p>", images: ['sokka-1.jpg']},
