...
// project data
var projectData = {
'give&take': {title: 'React Chat Application', property: 'Sketch<br>Mockup<br>React<br>Redux<br>Firebase',text: "This is a personal project named \"give&take\". After finishing the design using Sketch, I'm working on developing the application using react ×redux ×firebase. The concept of this application is similar with Craigslist, but this application will allow us to trade other than monry. We are not motivated only by money, but also value the give and take of a relationship. I hope that this way of thinking will have an impact on our life style. <p class=\"link\"><a href=\"https://givetake-8a57a.web.app\" target=\"blank\"> \>\> View the website</a>&nbsp;&nbsp;<a href=\"https://github.com/backy22/givetake\" target=\"blank\"> \>\> Sourse code</a><p>", images: ['give&take-1.jpg', 'h7D4t1jYDgs']},
